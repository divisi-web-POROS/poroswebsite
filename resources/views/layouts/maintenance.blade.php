...
<!--      <meta name="description" content="">
     ...
     <link rel="stylesheet" href="{{ asset('maintenance/css/vegas.min.css') }}">
     <link rel="stylesheet" href="{{ asset('maintenance/css/font-awesome.min.css') }}">

     <!-- MAIN CSS -->
     <link rel="stylesheet" href="{{ asset('maintenance/css/templatemo-style.css') }}">
           ...
           <div class="col-md-4 col-sm-6">
             <address>
               ...
               <div class="google-map">
                  <iframe src="https://www.google.com/maps/@-7.9546853,112.6142289,20z" allowfullscreen></iframe>
               </div>
             </address>
           </div> 
        ...
        <div class="overlay"></div>
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                         <div class="home-info">
                              <h1 style="font-weight: bold">We are getting ready <br>to launch new site!</h1>
...
<!--                               <ul class="countdown">
     ...
     <script src="{{ asset('maintenance/js/vegas.min.js') }}"></script>
     <!-- <script src="maintenance/js/countdown.js"></script> -->
     <!-- <script src="{{ asset('maintenance/js/init.js') }}"></script> -->
